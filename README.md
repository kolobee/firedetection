Данное веб-приложение для распознавания лесных пожаров на основе свёрточной нейронной сети - выпускная квалификационная работа бакалавриата в ЯГТУ и является социально-значимым.
